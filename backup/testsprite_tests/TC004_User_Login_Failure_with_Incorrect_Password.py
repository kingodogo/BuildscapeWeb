...
async def run_test():
    ...
    try:
        ...
        # -> Click on 'Sign In' button with index 6 to navigate to login page.
        ...
        # -> Input username 'Kingodogo' and incorrect password 'wrongpassword'.
        frame = context.pages[-1]
        ...
        try:
            ...
            raise AssertionError("Test case failed: The system did not prevent login with incorrect password as expected. The error message indicating invalid credentials was not displayed.")
